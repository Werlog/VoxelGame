...
#include "../block.h"
#include "../blockshape/cactusshape.h"
...
protected:
	std::shared_ptr<CactusShape> cactusShape;

	bool validate(glm::ivec3 pos, World& world);
	int calculateStemLength(glm::ivec3 pos, World& world);
};
