#include "block/blockshape/slabtopshape.h"

SlabTopShape::SlabTopShape(int frontFaceTexId, int rightFaceTexId, int backFaceTexId, int leftFaceTexId, int topFaceTexId, int bottomFaceTexId)
	: BlockShape(BlockShapeType::SLAB_TOP)
{
	BlockShapeFace frontFace = BlockShapeFace
	{
		0.5f, 0.75f, 1.0f, // Offset
		1.0f, 0.5f, // Scale
		0.0f, 0.0f, // Rotation
