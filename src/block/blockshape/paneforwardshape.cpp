#include "block/blockshape/paneforwardshape.h"

PaneForwardShape::PaneForwardShape(int textureId)
	: BlockShape(BlockShapeType::PANE_FORWARD)
{
	BlockShapeFace frontFace = BlockShapeFace
	{
		0.5f, 0.5f, 0.55f, // Offset
		1.0f, 1.0f, // Scale
		0.0f, 0.0f, // Rotation
