#include "block/blockshape/cubeshape.h"

CubeShape::CubeShape(int frontFaceTexId, int rightFaceTexId, int backFaceTexId, int leftFaceTexId, int topFaceTexId, int bottomFaceTexId)
	: BlockShape(BlockShapeType::CUBE)
{
